...
public class SimpleFramework_AppConstWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("UseAssetBundle", get_UseAssetBundle, null),
			new LuaField("isPBencrypted", get_isPBencrypted, null),
			new LuaField("AssetBundleName", get_AssetBundleName, null),
			new LuaField("luaRootPath", get_luaRootPath, set_luaRootPath),
	...
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.UseAssetBundle);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_isPBencrypted(IntPtr L)
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.isPBencrypted);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.AssetBundleName);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_luaRootPath(IntPtr L)
	{
		LuaScriptMgr.Push(L, SimpleFramework.AppConst.luaRootPath);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_luaRootPath(IntPtr L)
	{
		SimpleFramework.AppConst.luaRootPath = LuaScriptMgr.GetString(L, 3);
		return 0;
	}
