...
public class SimpleFramework_Manager_NetworkManagerWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("SendPost", SendPost),
			new LuaMethod("SendGet", SendGet),
	...
	static int AddEvent(IntPtr L)
	{
		...
		if (count == 1)
		{
			...
			SimpleFramework.Manager.NetworkManager.AddEvent(arg0);
			return 0;
		}
		else if (count == 2)
		{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: SimpleFramework.Manager.NetworkManager.AddEvent");
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SendPost(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 3);
		SimpleFramework.Manager.NetworkManager obj = (SimpleFramework.Manager.NetworkManager)LuaScriptMgr.GetUnityObjectSelf(L, 1, "SimpleFramework.Manager.NetworkManager");
		string arg0 = LuaScriptMgr.GetLuaString(L, 2);
		string arg1 = LuaScriptMgr.GetLuaString(L, 3);
		obj.SendPost(arg0,arg1);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SendGet(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 3);
		SimpleFramework.Manager.NetworkManager obj = (SimpleFramework.Manager.NetworkManager)LuaScriptMgr.GetUnityObjectSelf(L, 1, "SimpleFramework.Manager.NetworkManager");
		string arg0 = LuaScriptMgr.GetLuaString(L, 2);
		string arg1 = LuaScriptMgr.GetLuaString(L, 3);
		obj.SendGet(arg0,arg1);
		return 0;
	}
