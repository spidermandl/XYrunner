...
public class SimpleFramework_UtilWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("LoadPrefabByPath", LoadPrefabByPath),
			new LuaMethod("LoadAudioClipByPath", LoadAudioClipByPath),
			new LuaMethod("PlayBackGroundSound", PlayBackGroundSound),
			new LuaMethod("PlayEffectSound", PlayEffectSound),
			new LuaMethod("SetSoundVolume", SetSoundVolume),
			new LuaMethod("PreLoad", PreLoad),
			new LuaMethod("getLoadingProgress", getLoadingProgress),
			new LuaMethod("EncryptStringToBytes_Aes", EncryptStringToBytes_Aes),
			new LuaMethod("DecryptStringFromBytes_Aes", DecryptStringFromBytes_Aes),
			new LuaMethod("DecryptBytesFromBytes_Aes", DecryptBytesFromBytes_Aes),
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("AssetBundlePath", get_AssetBundlePath, null),
	...
	{
		LuaScriptMgr.Push(L, SimpleFramework.Util.AssetBundlePath);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, SimpleFramework.Util.PlatformName);
		return 1;
	}
	...
	{
		LuaScriptMgr.CheckArgsCount(L, 0);
		SimpleFramework.Util.releaseMemory();
		return 0;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int LoadPrefabByPath(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		string arg1 = LuaScriptMgr.GetLuaString(L, 2);
		Object o = SimpleFramework.Util.LoadPrefabByPath(arg0,arg1);
		LuaScriptMgr.Push(L, o);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int LoadAudioClipByPath(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		string arg1 = LuaScriptMgr.GetLuaString(L, 2);
		AudioClip o = SimpleFramework.Util.LoadAudioClipByPath(arg0,arg1);
		LuaScriptMgr.Push(L, o);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int PlayBackGroundSound(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		SimpleFramework.Util.PlayBackGroundSound(arg0);
		return 0;
	}
	...
	static int PlayEffectSound(IntPtr L)
	{
		...
		SimpleFramework.Util.PlayEffectSound(arg0,arg1,arg2);
		return 0;
	}
	...
	static int SetSoundVolume(IntPtr L)
	{
		...
		SimpleFramework.Util.SetSoundVolume(arg0);
		return 0;
	}
	...
	static int PreLoad(IntPtr L)
	{
		...
		SimpleFramework.Util.PreLoad(objs0);
		return 0;
	}
	...
	{
		LuaScriptMgr.CheckArgsCount(L, 0);
		float o = SimpleFramework.Util.getLoadingProgress();
		LuaScriptMgr.Push(L, o);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int EncryptStringToBytes_Aes(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		byte[] o = SimpleFramework.Util.EncryptStringToBytes_Aes(arg0);
		LuaScriptMgr.PushArray(L, o);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DecryptStringFromBytes_Aes(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		byte[] objs0 = LuaScriptMgr.GetArrayNumber<byte>(L, 1);
		string o = SimpleFramework.Util.DecryptStringFromBytes_Aes(objs0);
		LuaScriptMgr.Push(L, o);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DecryptBytesFromBytes_Aes(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		byte[] objs0 = LuaScriptMgr.GetArrayNumber<byte>(L, 1);
		byte[] o = SimpleFramework.Util.DecryptBytesFromBytes_Aes(objs0);
		LuaScriptMgr.PushArray(L, o);
		return 1;
	}
}
