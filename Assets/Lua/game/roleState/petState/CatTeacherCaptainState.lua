...
CatTeacherCaptainState =  class (BasePetState)
CatTeacherCaptainState._name = "CatTeacherCaptainState"
CatTeacherCaptainState.stage = nil --状态步骤
CatTeacherCaptainState.targetPos = nil--停留的目标位置
CatTeacherCaptainState.CD_time = nil --cd时间
CatTeacherCaptainState.act_map = nil --动作stage索引table
CatTeacherCaptainState.effect_map = nil --动作特效索引table
CatTeacherCaptainState.aristSpeed = nil -- 萌宠冲向玩家速度
CatTeacherCaptainState.ContinuedSpeed = nil -- 萌宠飞行速度
CatTeacherCaptainState.duringTime = nil --出现后持续显示时间
CatTeacherCaptainState.PrizeItemId = nil --奖励道具ID

function CatTeacherCaptainState:Enter(role)
...
function CatTeacherCaptainState:Excute(role,dTime)
...
function CatTeacherCaptainState:createPrize(role)
...
function CatTeacherCaptainState:Exit(role)
